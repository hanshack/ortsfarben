...
Select _ALKIS Berlin (Amtliches Liegenschaftskatasterinformationssystem)_

Then select _ALKIS Berlin Tatsächliche Nutzung_ on the right to get the WFS Link to download the data.
...
The tiles were created with _tippecanoe_ by running the following command:
...
The landuse data _ALKIS Berlin_ can be downloaded from the Geoportal Berlin.
